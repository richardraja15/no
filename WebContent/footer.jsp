    ...
    <script>
		...
		.then(data => {
			data.forEach(d => {
				...
				$("#drop").append("<form class='form-hover' action='RestaurantServlet' method='post'><li><button class='btn-btn' type='submit' name='restaurantId' value=" + d.restaurantId + ">" + d.restaurantName + "</button></li></form>");
			})
		});
		fetch("MenuServlet")
		.then(res => res.json())
